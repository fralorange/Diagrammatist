...
{
    /// <summary>
    /// A class that represents viewmodel of yes or no decision dialog window.
    /// </summary>
    public partial class YesNoDialogViewModel : ObservableObject
    {
        /// <summary>
        ...
        public YesNoDialogViewModel(string message, string caption, Action<bool?> respond)
        {
            Message = message;
            Caption = caption;
            _respond = respond;
